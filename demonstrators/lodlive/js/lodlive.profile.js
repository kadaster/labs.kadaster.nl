$.jStorage
        .set(
                'profile',
                {
                    ...
                    'connection' : {
			'http://bag.basisregistraties.overheid.nl,http://brk.basisregistraties.overheid.nl,https://data.labs.kadaster.nl,http://data.labs.kadaster.nl,http://bgt.basisregistraties.overheid.nl,http://api.labs.kadaster.nl,https://api.labs.kadaster.nl' : {
			description : {
				en : 'Dit is de BAG!' 
			},
			    endpointType: 'all',
