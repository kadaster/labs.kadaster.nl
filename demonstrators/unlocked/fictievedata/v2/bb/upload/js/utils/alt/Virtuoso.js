...
(function(factory) {
    ...
    if (isNode) {
       ...
       // 	 console.log(url);
            ...
            req_url=req_url.replace("/&[object%20Object]","");
     ...
     ajaxSettings = {
          ...
          //  req_url="http://virtuoso.otl-spoor.sysunite.com/sparql?default-graph-uri=&query=sele…stinct%20%3FConcept%20where%20%7B%5B%5D%20a%20%3FConcept%7D%20LIMIT%20100";
