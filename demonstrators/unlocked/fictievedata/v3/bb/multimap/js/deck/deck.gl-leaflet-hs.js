(function (global, factory) {
    ...
    function createDeckInstance(map, container, deck, props) {
      if (!deck) {
       // console.log("niew deck");

        var viewState = getViewState(map);
        var options=_objectSpread(_objectSpread({}, props), {}, {
            parent: container,
            //controller: {inertia: true,radius:100,pickingRadius:240,doubleClickZoom:false},
            style: {
              zIndex: 'auto'
            },
            viewState: viewState
          ...
          options.controller={inertia: true,radius:100,pickingRadius:240,doubleClickZoom:false};
          options.controller=true;
        deck = new core.Deck(options);
      }
       //onsole.log(deck);
