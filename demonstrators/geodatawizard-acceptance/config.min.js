...
const kerken_nederland_geodatawizard_namespaceObject = "﻿Kerk,Straat,Huisnummer,Postcode,Woonplaats,Denominatie\r\nMunsterkerk,Munsterplein,12,6041HD,Roermond,Rooms-Katholiek Kerkgenootschap in Nederland\r\nDe Grote of St. Bavokerk te Haarlem,Oude Groenmarkt,3,2011HL,Haarlem,Protestantse Kerk in Nederland: Protestantse Gemeente\r\nPlein Kerk,Plein,27,3991DL,Houten,Hersteld Hervormde Kerk\r\nLutherse Kerk,Hondstraat,6,6211HX,Maastricht,Pinkstergemeente\r\nDoopsgezind Amsterdam,Singel,452,1017AW,Amsterdam,Algemene Doopsgezinde Sociëteit\r\nOud-katholieke Parochie vd H.H Jacobus en Augustinus,Juffrouw Idastraat,7,2513BE,s-Gravenhage,Oud-Katholieke Kerk van Nederland\r\nPieterskerk,Pieterskerkhof,5,3512JR,Utrecht,Christian Science Nederland & School voor openbaar basisonderwijs\r\nOude Kerk Oosterbeek,Benedendorpseweg,134,6862WP,Oosterbeek,Protestantse Kerk in Nederland: Protestantse Gemeente\r\n";
  ...
  _van_bag_id_naar_kkg_iri_f = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "https://data.labs.kadaster.nl/GeoData-Wizard/-/queries/van-bag-id-naar-kkg-iri?id=".concat(id);
          _context.prev = 1;
          _context.next = 4;
  ...
  _van_bag_pand_id_naar_kkg_geometrie_f = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          url = "https://data.labs.kadaster.nl/GeoData-Wizard/-/queries/van-bag-pand-id-naar-kkg-geometrie?id=".concat(id);
          _context4.prev = 1;
          _context4.next = 4;
          return fetchCall(url);
        case 4:
        ...
        case 8:
          return _context4.abrupt("return", results === null || results === void 0 || (_results$4 = results[0]) === null || _results$4 === void 0 ? void 0 : _results$4.iri);
        case 11:
          _context4.prev = 11;
...
function _van_woonplaats_naar_kkg_woonplaats_f() {
  _van_woonplaats_naar_kkg_woonplaats_f = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(woonplaats) {
    var _result$, response, term, url, result;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 7:
          term = response.response.docs[0].woonplaatsnaam;
          url = "https://api.labs.kadaster.nl/queries/GeoData-Wizard/bag-woonplaats/run?woonplaats=".concat(term);
          _context7.next = 11;
          return fetchCall(url);
        case 11:
          result = _context7.sent;
          return _context7.abrupt("return", result === null || result === void 0 || (_result$ = result[0]) === null || _result$ === void 0 ? void 0 : _result$.woonplaatsIri);
        case 15:
          _context7.prev = 15;
...
var wizardConfig = {
  ...
  columnRefinements: [van_bag_id_naar_kkg_iri, van_wkt_punt_naar_kkg_gebouw, van_wkt_punt_naar_kkg_perceel,
  //van_bag_pand_id_naar_kkg_geometrie,
  van_woonplaats_naar_kkg_woonplaats, van_postcode_en_huisnummer_naar_kkg_nummeraanduiding, van_adres_en_woonplaats_naar_kkg_openbareRuimte],
