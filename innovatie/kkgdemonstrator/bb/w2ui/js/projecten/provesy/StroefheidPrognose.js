...
{
     console.log(uri);
       w2alert("processing. Dit kan even duren. Even geduld a.u.b.","stroefheid") ;
       try
       {
      var com={commando:"stroefheidcurve",uri:uri};
      var command=window.top.command;
      //if (command==null) command=window.top.command;



        console.log("send command stroefheid ")
      var jo=command.sendCommand2(com,function(arg)
      {
        console.log("send command stroefheid succeeded")
        w2popup.close();
        ...
        console.log("send command stroefheid unsuccessfull")
        w2popup.close();
    ...
    {
      w2popup.close();
      w2alert("Kan helaas geen stroefheid prognose berekenen","Stroefheid prognose error (22)") ;
