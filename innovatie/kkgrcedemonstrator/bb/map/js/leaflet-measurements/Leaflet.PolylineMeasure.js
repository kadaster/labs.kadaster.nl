    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        _toggleMeasure: function () {
           console.log("toggle");
        	...
        	//console.log("measurement on",  self._map); 
        	// if measuring is going to be switched on
                ...
                if ( self.bbparent!=null)
                    {
                       if (self.bbchild!=null)
                	   {
                	     self.bbparent.appendChild(self.bbchild);
                	   }
                    }
                ...
                // addition buildingbits
                   //setTimeout(function(){
                if (document.getElementsByClassName("leaflet-overlay-pane"))
                    {
                            try{
                        	var lop=document.getElementsByClassName("leaflet-overlay-pane")[0];
                           
                            self.bbparent= lop;
                            self.bbchild=lop.childNodes[0];
                            if (lop!=null) {     
                        	lop.removeChild(self.bbchild);}
                            }
