...
[WebVOWL](http://vowl.visualdataweb.org/webvowl.html) is een visualisatietool waarmee de samenhang van een semantisch model wordt weergegeven.  Met deze tool kunnen we bijvoorbeeld de gebruikte klassen en eigenschappen van de BAG tonen.  Klik op de afbeelding om het model te bekijken:

<figure>
  <a href="http://visualdataweb.de/webvowl/#iri=http://ec2-34-252-124-184.eu-west-1.compute.amazonaws.com/model/bag.ttl" target="_blank">>
    <img src="WebVOWL.png">
  </a>
</figure>
